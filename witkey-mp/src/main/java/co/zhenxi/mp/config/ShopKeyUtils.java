package co.zhenxi.mp.config;

import co.zhenxi.constant.ShopConstants;
import co.zhenxi.constant.SystemConfigConstants;
...
public class ShopKeyUtils {
    ...
    public static  String getYshopWeiXinMpSevice(){
        String yshopWeiXinMpSevice= ShopConstants.WITKEY_WEIXIN_MP_SERVICE;
    ...
    public static  String getYshopWeiXinPayService(){
        String yshopWeiXinPayService= ShopConstants.WITKEY_WEIXIN_PAY_SERVICE;
    ...
    public static  String getYshopWeiXinMiniPayService(){
        String yshopWeiXinMiniPayService= ShopConstants.WITKEY_WEIXIN_MINI_PAY_SERVICE;
    ...
    public static  String getYshopWeiXinAppPayService(){
        String yshopWeiXinAppPayService= ShopConstants.WITKEY_WEIXIN_APP_PAY_SERVICE;
